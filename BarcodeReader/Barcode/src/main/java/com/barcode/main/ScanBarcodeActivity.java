...
/**
 * Created by Srisht on 14-08-2017.
 */
...
public class ScanBarcodeActivity extends AppCompatActivity {
    ...
    private void setUIScanBarcode(){
        ...
        upArrow.setColorFilter(ContextCompat.getColor(contextScanBarcode, R.color.white), PorterDuff.Mode.SRC_ATOP);
